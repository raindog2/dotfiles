...
elseif awful.util.file_readable("home/mpurcell/.config/awesome/vain/init.lua") then
    theme.useless_gap_width  = "3"
end
--}}}
...
-- {{{ Colors
theme.fg_normal = "#939393"
theme.fg_focus  = "#22aa22"
theme.fg_urgent = "#992222"
theme.bg_normal = "#22222299"
theme.bg_focus  = "#222222cc"
theme.bg_urgent = "#34353475"
-- }}}
